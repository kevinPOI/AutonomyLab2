...
if __name__ == "__main__":
    ...
    right_shelf_xyz = get_block_pos(BLOCKS, "RShelfMiddle")

    pi = np.pi
    r_down, p_down, y_down = 3.13714399, 0.00419659, -0.80013718
    r_side, p_side, y_side = 1.53, 0.77, 3.12
    cart_waypoints = [
        ("descend_to_grasp", [0, block_xyz[0], block_xyz[1], block_xyz[2] + 0.07, r_down, p_down, y_down]),
        ("close_gripper", [1, block_xyz[0], block_xyz[1], block_xyz[2] + 0.07, r_down, p_down, y_down]),
        ("lift_block", [1, block_xyz[0], block_xyz[1], block_xyz[2] + 0.15, r_down, p_down, y_down]),
        ...
        ("return_hover_start", [0, block_xyz[0], block_xyz[1], block_xyz[2] + 0.20, r_down, p_down, y_down]),
    ]
    ...
    rt.add_free_block_to_model(tree=modelTree, name="Block", pos=block_xyz, density= 20 , size=[0.02, 0.02, 0.02] , rgba=[0.0, 0.9, 0.2, 1],free=True)
